...
namespace ClientGUI
{
    public partial class UserCheckBox : UserControl
    {
        public UserCheckBox()
        {
            ...
            if (File.Exists(ProgramConstants.gamepath + ProgramConstants.RESOURCES_DIR + "checkBoxClear.png"))
            {
                clearedImage = Image.FromFile(ProgramConstants.gamepath + ProgramConstants.RESOURCES_DIR + "checkBoxClear.png");
                checkedImage = Image.FromFile(ProgramConstants.gamepath + ProgramConstants.RESOURCES_DIR + "checkBoxChecked.png");
            }
